...
do
    ...
    -- White / blue design.  This is deliberately separate from the main hub.
    --------------------------------------------------------------------------
    ...
    second.BackgroundColor3 = Color3.fromRGB(248, 250, 255)
    ...
    secondGradient.Color = ColorSequence.new({
        ...
        ColorSequenceKeypoint.new(0.25, Color3.fromRGB(75, 175, 255)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(18, 45, 80)),
        ColorSequenceKeypoint.new(0.75, Color3.fromRGB(75, 175, 255)),
    ...
    secondTitle.TextColor3 = Color3.fromRGB(18, 45, 80)
    ...
    secondClose.BackgroundColor3 = Color3.fromRGB(225, 240, 255)
    secondClose.BorderSizePixel = 0
    secondClose.Font = Enum.Font.GothamBold
    secondClose.Text = "X"
    secondClose.TextColor3 = Color3.fromRGB(18, 45, 80)
    ...
    selectedText.BackgroundColor3 = Color3.fromRGB(235, 245, 255)
    selectedText.BorderSizePixel = 0
    selectedText.Font = Enum.Font.GothamBold
    selectedText.Text = "SELECTED EGG: NONE"
    selectedText.TextColor3 = Color3.fromRGB(25, 105, 220)
    ...
    autoStealButton.BackgroundColor3 = Color3.fromRGB(215, 235, 255)
    autoStealButton.BorderSizePixel = 0
    autoStealButton.Font = Enum.Font.GothamBold
    autoStealButton.Text = "AUTO STEAL [OFF]"
    autoStealButton.TextColor3 = Color3.fromRGB(18, 45, 80)
    ...
    eggList.BackgroundColor3 = Color3.fromRGB(18, 45, 80)
    eggList.BackgroundTransparency = 0.15
    eggList.BorderSizePixel = 0
    eggList.ScrollBarThickness = 3
    eggList.ScrollBarImageColor3 = Color3.fromRGB(45, 140, 255)
    ...
    local function setSecondAutoVisual(on)
        ...
        autoStealButton.BackgroundColor3 = autoStealOn
            and Color3.fromRGB(65, 155, 235)
            or Color3.fromRGB(215, 235, 255)
    end
    ...
    local function refreshEggView()
        ...
        if #list == 0 then
            ...
            empty.TextColor3 = Color3.fromRGB(70, 120, 180)
            empty.TextSize = 9
            empty.ZIndex = 22
            return
        end
    ...
    secondOpen.TextColor3 = Color3.fromRGB(35, 125, 245)
    ...
    secondOpenStroke.Color = Color3.fromRGB(55, 155, 255)
